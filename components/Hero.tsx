...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#4a635b]/90 to-black/70"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
        <div className="max-w-3xl">
          <span className="inline-block py-1 px-4 rounded-full bg-[#6b8e83]/20 text-white font-semibold text-sm mb-6 border border-[#6b8e83]/40">
            Terceirização Profissional
          </span>
          <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
            Soluções completas em <span className="text-[#6b8e83]">terceirização</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <a 
              href="#contato" 
              className="bg-[#6b8e83] hover:bg-[#5b7a70] text-white font-bold py-4 px-8 rounded-lg flex items-center justify-center transition-all transform hover:scale-105"
            >
              Solicitar Orçamento
